...
public class BeenkerRhomb extends JPanel {
    ...
    List<Tile> setupPrototiles(int w, int h) {
        ...
        proto.add(new Tile(Type.Thin, w / 2, h / 2, toRadians(160), w / 10));
    ...
    void drawTiles(Graphics2D g) {
        ...
        try {
            writer = new PrintWriter("D:\\R3.txt");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            f.setResizable(true);
            f.add(new BeenkerRhomb(), BorderLayout.CENTER);
            f.pack();
