...
public class PenroseThin extends JPanel {
    ...
    List<Tile> setupPrototiles(int w, int h) {
        ...
        //proto.add(new Tile(Type.Fat, w / 2, h / 2, toRadians(-18), w / 10));
    ...
    public void paintComponent(Graphics og) {
        ...
        try (PrintStream printStream = new PrintStream(
                new FileOutputStream("D:\\FYP\\T6.txt"))) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            f.setResizable(true);
            f.add(new PenroseThin(), BorderLayout.CENTER);
            f.pack();
